    ...
    plugins: [
      ...
      UnoCSS({
        ...
        shortcuts: {
          ...
          "btn-cta": "btn bg-amber-400 text-black hover:translate-y-0.5 active:translate-y-1",
          "btn-danger": "btn bg-red-400 text-white hover:translate-y-0.5 active:translate-y-1",
