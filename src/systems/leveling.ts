...
export const LEVEL_DEFS: ILevelDef[] = [
  { maxCops: 3, spawnInterval: 4, scoreThreshold: 0, hpHeal: 15, bountyRate: 0, swatEnabled: false } /* Level 1 — medium start */,
  { maxCops: 5, spawnInterval: 3, scoreThreshold: 100, hpHeal: 15, bountyRate: 0.16, swatEnabled: false } /* Level 2 — ~10s in */,
  { maxCops: 6, spawnInterval: 2.5, scoreThreshold: 300, hpHeal: 15, bountyRate: 0.16, swatEnabled: false } /* Level 3 — ~30s */,
  { maxCops: 7, spawnInterval: 2, scoreThreshold: 600, hpHeal: 15, bountyRate: 0.16, swatEnabled: false } /* Level 4 — ~55s */,
  { maxCops: 8, spawnInterval: 1.5, scoreThreshold: 1000, hpHeal: 15, bountyRate: 0.16, swatEnabled: false } /* Level 5 — ~80s */,
  { maxCops: 9, spawnInterval: 1.3, scoreThreshold: 1500, hpHeal: 15, bountyRate: 0.16, swatEnabled: false } /* Level 6 */,
  { maxCops: 10, spawnInterval: 1.1, scoreThreshold: 2200, hpHeal: 20, bountyRate: 0.16, swatEnabled: true } /* Level 7 — SWAT unlocks */,
  { maxCops: 11, spawnInterval: 1.0, scoreThreshold: 3000, hpHeal: 20, bountyRate: 0.16, swatEnabled: true } /* Level 8 */,
  { maxCops: 12, spawnInterval: 0.9, scoreThreshold: 4000, hpHeal: 20, bountyRate: 0.16, swatEnabled: true } /* Level 9 */,
  { maxCops: 13, spawnInterval: 0.8, scoreThreshold: 5500, hpHeal: 25, bountyRate: 0.16, swatEnabled: true } /* Level 10 — peak intensity */,
];
