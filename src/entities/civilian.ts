...
export class Civilian {
  ...
  constructor(scene: THREE.Scene, world: CANNON.World, position: THREE.Vector3) {
    ...
    /* Drive forward + follow roads. Uses module-scope scratch Vec3s to avoid allocations on the hot loop. */
    this.preStepCallback = () => {
      ...
      /* Arcade friction — strong lateral grip. Re-read _civLocalVel after applyLocalForce may have mutated body.velocity. */
      this.body.vectorToLocalFrame(this.body.velocity, _civLocalVel);
      _civLocalVel.x *= 0.7;
      _civLocalVel.z *= 0.98;
